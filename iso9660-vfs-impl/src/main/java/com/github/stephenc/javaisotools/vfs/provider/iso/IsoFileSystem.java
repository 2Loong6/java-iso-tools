...
/**
 * Implementation of {@link org.apache.commons.vfs2.FileSystem} for ISO9660 (.iso) files.
 * <p>
...
public class IsoFileSystem extends AbstractFileSystem {
    ...
    public void init() throws FileSystemException {
        ...
        // Build the index
        final List<IsoFileObject> strongRef = new ArrayList<>(100);
        ...
        for (Iso9660FileEntry entry : this.fileSystem) {
            ...
            fileObj = new IsoFileObject((AbstractFileName) filename, entry, this);
            ...
            for (FileName parentName = filename.getParent(); parentName != null;
                ...
                if (parent == null) {
                    parent = new IsoFileObject((AbstractFileName) parentName, this);
